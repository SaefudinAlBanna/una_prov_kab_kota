...
// class DashboardDinasView extends GetView<DashboardController> {
//   // Inject SchoolMgmtController agar bisa akses data statistik & list
//   final SchoolMgmtController schoolC = Get.put(SchoolMgmtController());
...
//   @override
//   Widget build(BuildContext context) {
//     // LOGIC PEMILIHAN NAMA WILAYAH
//     String wilayahDisplay = "Memuat Wilayah...";
//     var user = controller.authC.userModel.value;

//     if (user != null) {
//       if (user.role == 'dinas_prov') {
//         wilayahDisplay = "Provinsi ${user.scopeProv ?? '-'}";
//       } else if (user.role == 'dinas_kab') {
//         wilayahDisplay = "${user.scopeDist ?? '-'}";
//       }
//     }

//     return Scaffold(
//       backgroundColor: Colors.grey[50], // Background sedikit lebih terang
//       appBar: AppBar(
//         title: const Text('Command Center Dinas', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
//         backgroundColor: Colors.blue[900], 
//         elevation: 0,
...
//       body: Column(
//         children: [
//           // BAGIAN HEADER & STATISTIK (Fixed di atas)
//           Container(
//             padding: const EdgeInsets.fromLTRB(20, 10, 20, 20),
//             decoration: BoxDecoration(
//               color: Colors.white,
...
//                         ),
//                         Text(
//                           controller.authC.userModel.value?.nama ?? 'Admin',
...
//                 // Kartu Statistik Real-time (Menggunakan Obx)
//                 Obx(() => Row(
//                   children: [
//                     _buildStatCard(
//                       "Total Sekolah", 
//                       "${schoolC.totalSekolah.value}", 
//                       Colors.orange, 
//                       Icons.school
//                     ),
//                     const SizedBox(width: 15),
//                     _buildStatCard(
//                       "Est. Siswa", 
//                       "${schoolC.totalSiswaEstimasi.value}", 
//                       Colors.blue, 
//                       Icons.people
//                     ),
//                   ],
...
//           // BAGIAN LIST SEKOLAH (Scrollable di bawah)
//           Expanded(
//             child: Container(
//               color: Colors.grey[50],
//               child: SchoolListView(), // Memanggil View List Sekolah yang sudah kita buat
//             ),
//           ),
//         ],
//       ),
